...
<<<<<<< HEAD
            for index in range(80):
                self.test_pos(Motor.FR_SHOULDER,Motor.FR_ELBOW,x[index],y[index],right=True)
                self.test_pos(Motor.BR_SHOULDER,Motor.BR_ELBOW,x[(index+20)%80],y[(index+20)%80],right=True)
                self.test_pos(Motor.FL_SHOULDER,Motor.FL_ELBOW,x[(index+40)%80],y[(index+40)%80],right=False)
                self.test_pos(Motor.BL_SHOULDER,Motor.BL_ELBOW,x[(index+60)%80],y[(index+60)%80],right=False)
                time.sleep(0.02)
=======
